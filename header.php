...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="<?php echo theme_url('/css/master.css'); ?>">
	...
	<body class="<?php echo body_class(); ?>">
		...
		<div class="main-wrap">
			<div class="slidey" id="tray">
				<div class="wrap">
					<form id="search" action="<?php echo search_url(); ?>" method="post">
						<label for="term">Pesquisa no Mais Contos:</label>
						<input type="search" id="term" name="term" placeholder="Para pesquisar, clica enter&hellip;" value="<?php echo search_term(); ?>">
			...
			<header id="top">
				...
				<div class="mc-inner">
					<div class="mc-title" onclick="location.href = '/';">Mais Contos <span class="blinking-cursor">|</span></div>
				</div>
			</header>
